...
export class ApplyLoanComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,
      ...
      this.loanService.getProductOptions().subscribe((data: {productOptions: any , purposeOptions: any}) => {
        const { productOptions } = data.productOptions;
        console.log("from loan",data.productOptions);
        this.productOptions = data.productOptions;
        this.loanProductDetails = data.purposeOptions;
      });
    }
